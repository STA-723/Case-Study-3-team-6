...
sectionb_names <- c(paste0("B", c(1, 3, 4, 5)), 
                    colnames(cas01)[grepl("B7", colnames(cas01))], "B19",
                    colnames(cas01)[grepl("B21", colnames(cas01))])
sectionc_names <- c(paste0("C", c(1:7, 9, 10:13)), 
...
I hope these summaries are helpful for you when you are actually fitting the model. One thing to beware is that there is a mix of ordinal and categorical variables here, so this may or may not cause you fitting issues.
