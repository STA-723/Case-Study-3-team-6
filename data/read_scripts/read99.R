...
## Filenames
meta_fn <- "03818-0001-Record_layout.txt"
data_fn <- "03818-0001-Data.txt"
# Reading metadata file: Skip the first 10 lines
meta <- readLines(meta_fn)[c(11:465)]
...
write.csv(result, file = "HarvardCAS99.csv", quote = FALSE, row.names = FALSE)
